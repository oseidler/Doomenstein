...
void App::Startup()
{
	...
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " 1: First Weapon");
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " 2: Second Weapon");
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " Left Click: Fire Weapon");
	...
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " F: Toggle Camera Mode");
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " N: Debug Possess Next Actor");
	g_theDevConsole->AddLine(DevConsole::COLOR_INFO_MINOR, " P: Pause");
...
void App::Update()
{
	...
	//{
	//	if (m_theGame->m_currentState == GameState::ATTRACT)
	//	{
	//		HandleQuitRequested();
	//	}
	//	else
	...
	if (!g_theDevConsole->IsOpen() && Window::GetWindowContext()->HasFocus() && m_theGame->m_currentState != GameState::ATTRACT)
	{
